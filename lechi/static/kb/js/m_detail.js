...
$(document).on('touchstart', ".comment_click", function(event) {
     touchStartLocation = event.view.scrollY;
});
$(document).on('touchend', ".comment_click", function(event) {
     ...
     if (distance < 10  )
     {
        ...
        var username =  $($(this)[0].nextElementSibling).attr('username');
        var commentid= $($(this)[0].nextElementSibling).attr('commentid');
        ...
        $('#current_commentid').val(commentid); 
